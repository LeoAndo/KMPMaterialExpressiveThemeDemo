# KMPプロジェクトにMaterialExpressiveThemeを導入するデモ

2025/9/20時点のKotlin Multiplatform Wizardで作成できるKMPプロジェクトでは、composeMultiplatform = "1.9.0"を指定しているが、MaterialExpressiveThemeがデフォルトで適用されていません<br>
